...
Between 2016-2022, the democratic party registration #s increased. 
...
(YEAR == '2022')
 ...
 #I tried to think of how to subtract the two rows to find the difference, and then got stuck. 
...
**Task** Run the following code to join Maryland population data and the 2022 voter registration data together using the common column county as the key. 

How many rows are there now? 

#24

How many *should* there be? **Answer**
...
18+ population demographic information by county
...
**Answer**
Howard and Montomgery Counties have higher Asian populations for 18+. The book notes that jurisdictions with the highest percentage of democrats have small Asian populations; however Montgomery county has a higher percentage of democrats at 60.7% and has the 2nd largest asian population. 
...
It is now a character, which is the proper representation for zip codes. I wouldn't have thought of it, but it makes sense. 
