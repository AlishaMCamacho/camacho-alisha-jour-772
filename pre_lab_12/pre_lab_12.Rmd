...
##
**AC Question to ask in class** 
I am seeing "Large list (542 elements)" as opposed to "list of 11." I am looking at all of the press releases; they are not organized in 11 distinct tables by year. Did I do something wrong?
##
...
**Answer** 
When I run this code, I am only getting the first press release, not all of 2023. 

I used Chat GPT to get all of 2023: https://chat.openai.com/share/0588b0d4-d588-4323-b153-c2385e96bb15
...
# AC updated code to keep the first 31 tables (2023 press releases) 

results <- results[1:31]
...
```{r}
#original code from Derek below
...
#AC Adjusted code
Disclaimer: I used Chat GPT, which lead me to using bind_rows
https://chat.openai.com/share/db3e594a-3315-4226-9f1a-6c132db2b5b9


```{r}

results_AC <- bind_rows(results) |> 
  clean_names() |> 
...
**Task** Run the following code in the gray-colored codeblock below to find the <li> tags.

What does the output suggest about how many <ul> tags there are in the HTML source?

**AC Q for class**
what is a ul "tag"? 

**Answer** 
There is a lot going on here; I'm not sure what is relevant vs. not. 
...
**Answer** 
I am able to make out which parts are (most likely) the press releases 

**AC Question for class** 
what exactly does html_text do? 
